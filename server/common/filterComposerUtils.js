...
let addMarketCapFilter = (filterQuery, mCaps) => {
    ...
    for(let c of mCaps) {
        if(c === 'l'){
            cps.push({marketCapNumberic: {$gte: (10 * 1000 * 1000 * 1000), }});
        } else if(c === 'm') {
            cps.push({marketCapNumberic: {$gte: 2 * 1000 * 1000 * 1000, $lte: 10 * 1000 * 1000 * 1000}});
        } else if(c === 's') {
            cps.push({marketCapNumberic: {$gte: 300 * 1000, $lte: 2 * 1000 * 1000 * 1000}});
        }
    }
